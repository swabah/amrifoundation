...
function HomeFive() {
  return (
    <div className='w-full h-auto'>
      ...
      <div  className='flex flex-col items-center justify-center w-full h-full gap-10 px-3 py-10 overflow-hidden lg:flex-row md:px-10 lg:px-10 xl:px-36 md:py-16 lg:py-20 xl:py-28'>
