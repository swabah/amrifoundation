...
function HomeEight() {
  return (
      <div style={{ backgroundImage: `url(${humanitarian})` }} className="w-full bg-no-repeat bg-cover crelative">
        <div className='flex bg-[#000000ae] flex-col px-5 py-16 items-center justify-center w-full z-10 h-full text-center gap-4 p-8 lg:gap-8 md:px-20 lg:px-36 xl:px-44 md:py-20 lg:py-24 xl:py-32'>
          <h2 className='w-full text-4xl text-center md:text-5xl xl:text-6xl font-bold text-[#91cadb] '>Know About Us</h2>
