...
function Events() {
  ...
  return (
    <div className='w-full h-full min-h-screen bg-white'>
      <div className='flex flex-col items-center justify-center w-full h-full gap-10 px-3 py-20 text-center md:gap-16 lg:gap-12 md:px-10 lg:px-10 xl:px-36'>
      ...
      <div style={{ backgroundImage: `url(${PatternBg})` }} className='relative px-3 py-8 bg-no-repeat space-y-7 md:px-10 lg:px-10 xl:px-36 md:py-14 lg:space-y-12'>
