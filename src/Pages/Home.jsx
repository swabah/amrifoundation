    ...
    <div className='w-full h-full bg-white'>
      <div id='Home' className='relative flex flex-col items-center justify-center w-full h-screen space-y-5 bg-center '>
        <div className='absolute inset-0 w-full h-full '>
          <div className='absolute  gap-2 lg:gap-5 pt-20 inset-0 w-full h-full flex flex-col items-center justify-center bg-[#00000061] z-10 text-center px-5 py-16 md:px-10 lg:px-10 xl:px-36 lg:py-20 xl:py-24'>
